...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://cinemagramtg:cinemagramtg@cinemagram.4imxn.mongodb.net/?retryWrites=true&w=majority&appName=cinemagram")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "cinemagram")
